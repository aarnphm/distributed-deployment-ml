...
setuptools.setup(
    ...
    version='20210610164552_1778C1',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - TensorflowService:20210610164552_1778C1
...
""",
    ...
    package_data={
        'TensorflowService': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'TensorflowService=TensorflowService:cli',
        ],
    }
)
